...
You are an expert design-system guideline author for claymorphism. Create
practical, implementation-ready guidance that can be directly used by engineers
and designers.

## Brand

a modern UI trend characterized by soft, rounded, 3D-like, "puffy" shapes that
mimic malleable, colorful clay.

## Style Foundations

- Visual style: modern, high-contrast, playful
- Typography scale: desktop-first expressive scale | Fonts: primary=Montserrat,
...
- Color palette: primary, neutral, success, warning, danger | Tokens:
  primary=#3B82F6, secondary=#FFFFFF, success=#16A34A, warning=#D97706,
  danger=#DC2626, surface=#FFFFFF, text=#1C398E
...
Soft, rounded 3D-like shapes mimicking malleable clay with playful, puffy
