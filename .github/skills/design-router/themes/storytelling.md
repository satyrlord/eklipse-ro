...
a narrative techniques to create engaging, intuitive, and emotionally resonant
digital experiences. It guides users through a cohesive journey using visuals,
copy, and interaction, transforming functional interfaces into memorable
experiences.
...
- Typography scale: desktop-first expressive scale | Fonts: primary=Inter,
  display=Abril Fatface, mono=JetBrains Mono | weights=100, 200, 300, 400, 500,
  600, 700, 800, 900
...
Narrative-driven design using visuals, copy, and interaction to guide users
...
- **Typography fonts:** primary=Inter, display=Abril Fatface, mono=JetBrains
  Mono
