...
- Typography scale: desktop-first expressive scale | Fonts: primary=Macondo,
  display=Macondo, mono=JetBrains Mono | weights=100, 200, 300, 400, 500, 600,
  700, 800, 900
...
Throwback design with vintage-inspired typography, high-contrast retro palettes,
...
- **Typography fonts:** primary=Macondo, display=Macondo, mono=JetBrains Mono
