...
- Typography scale: desktop-first expressive scale | Fonts: primary=Oswald,
  display=Oswald, mono=JetBrains Mono | weights=100, 200, 300, 400, 500, 600,
  700, 800, 900
- Color palette: primary | Tokens: primary=#FAFAFA, secondary=#FAFAFA,
...
keyboard-first interactions, visible focus states, semantic HTML before ARIA,
44px+ touch targets, high-contrast support
...
High-end dark aesthetic with bold headings, monochromatic palette, and premium
feel for premium brand experiences.
