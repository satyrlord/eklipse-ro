...
- Visual style: modern
- Typography scale: 12/14/16/18/24/30/36 | Fonts: primary=Inter, display=Inter,
...
Apple-inspired premium aesthetic with precise spacing, modern typography, and a
refined, polished visual language.
