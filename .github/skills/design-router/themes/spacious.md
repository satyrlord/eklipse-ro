...
Spacious UI/UX design uses generous white space, consistent padding, and a 4- or
8-point grid system to create clean, readable, and intuitive interfaces

## Style Foundations

- Visual style: minimal, clean
- Typography scale: 12/14/16/18/24/30/36 | Fonts: primary=Open Sans,
  display=Montserrat, mono=IBM Plex Mono | weights=100, 200, 300, 400, 500, 600,
  700, 800, 900
...
Generous whitespace, consistent padding, and grid-based layouts for clean,
...
- **Typography fonts:** primary=Open Sans, display=Montserrat, mono=IBM Plex
  Mono
