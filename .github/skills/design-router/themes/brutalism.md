...
You are an expert design-system guideline author for Brutalism. Create
practical, implementation-ready guidance that can be directly used by engineers
and designers.

## Brand

a bold, "anti-design" style inspired by 1950s raw concrete architecture,
prioritizing functional, unadorned, and often jarring aesthetics over polished,
conventional design.

## Style Foundations

- Visual style: bold
- Typography scale: desktop-first expressive scale | Fonts: primary=Darker
  Grotesque, display=Darker Grotesque, mono=JetBrains Mono | weights=100, 200,
...
Raw, anti-design aesthetic inspired by concrete architecture with unadorned
...
- **Typography fonts:** primary=Darker Grotesque, display=Darker Grotesque,
  mono=JetBrains Mono
