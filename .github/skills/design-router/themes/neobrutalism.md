...
- Typography scale: 13/15/17/21/27/35 | Fonts: primary=Inter, display=Inter,
...
- Color palette: primary, neutral, success, warning, danger | Tokens:
  primary=#FDC800, secondary=#432DD7, success=#16A34A, warning=#D97706,
  danger=#DC2626, surface=#FBFBF9, text=#1C293C
...
Modern take on brutalism with bold borders, vivid accent colors, and raw,
...
- **Neutral (#FBFBF9):** Derived from the surface token for official format
  compatibility.
