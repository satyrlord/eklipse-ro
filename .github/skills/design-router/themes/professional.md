...
- Visual style: modern
- Typography scale: mobile-first compact scale | Fonts: primary=Poppins,
...
- Color palette: primary, secondary, neutral, success, warning, danger | Tokens:
  primary=#FECE14, secondary=#000000, success=#16A34A, warning=#D97706,
...
Polished, business-ready design with modern typography, structured layouts, and
a trustworthy visual identity.
