...
- Typography scale: 14/16/18/24/32/40 | Fonts: primary=Google Sans,
  display=Google Sans, mono=Anonymous Pro | weights=100, 200, 300, 400, 500, 600
...
Graceful, refined aesthetic with delicate typography, minimal palettes, and
...
- **Typography fonts:** primary=Google Sans, display=Google Sans, mono=Anonymous
  Pro
