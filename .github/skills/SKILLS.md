# eklipse Repository Skills

Use the skill that matches the user request.
...
Keep product-specific facts in `PRODUCT.md` and keep shared agent rules in `AGENTS.md`.
