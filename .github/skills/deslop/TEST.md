...
- Run the unchanged test suite before modifying tests.
- Keep tests for the Bandcamp link allowlist, absence of input/embed surfaces, and complete eleven-release catalog.
